    ...
    return {
      content: [
        ...
        },
        {
          columns: [
            {
              text: 'Pourra etre transporté sans danger pour la salubrité publique, le corps étant placé dans une bière hermetique, suivant les réglements et prescriptions en vigeur' ,  style: 'style',
            },
          ],
        },
        {
