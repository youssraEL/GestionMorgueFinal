      ...
      content: [
        ...
        },
        {
          columns: [
            ...
            {
              text: this.Medicolegal.declarant, style: 'style',
            },
          ],
        },
        {
          columns: [
            {
              text: 'CIN déclarant : ', style: 'style',
            },
            {
              text: this.Medicolegal.CIN, style: 'style',
            },
          ],
        },
        {
          columns: [
            {
              text: 'Adresse Déclarant : ' , style: 'style',
            },
            {
        ...
        },
        {
          columns: [
            ...
            {
              text: this.Medicolegal.declaration, style: 'style',
            },
          ],
        },
        {
