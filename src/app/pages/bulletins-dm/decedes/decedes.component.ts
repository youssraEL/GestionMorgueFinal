...
export class DecedesComponent implements OnInit {
 ...
 LieuD = ['Domicile', 'Hopital public', 'Clinique', 'Voie public', 'Lieu de travail', 'Autre'];
  ...
  Grossesse: string;
  AgeMere: string;
  CauseMort = ['accident', 'homicide', 'suicide', 'Inconnu', 'noyade', 'brûlure', 'intoxication', 'traumatisme', 'Maladie'];
  couseIni = [];
  maladie: string;
  AgeGesta: string;
  Poids: string;
              ...
              [
                {
                  ...
                  fontSize: 12,
                 // margin: [0, 10, 0, 10],
                  text: 'Décès survenu le:  ' + this.decede.dateDeces + '   S\'agit-il d\'un mort-né ?  ' + this.getTexte(this.decede.mortNe) +
                     '\n'
                    + 'lieu décès  :  ' + this.decede.lieuxDeces + '\n'
                    + 'Nom:  ' + this.decede.nom + '  Prénom: ' + this.decede.prenom + '   CNIE:' + this.decede.CIN + '\n'
                    + 'Sexe:  ' + this.decede.sexe + '       Nationalité: ' + this.decede.nationalite
                    + '\nDate de naissance:  ' + this.decede.dateNaissance + '\nLieu de naissance: ' + 'Lieu de naissance '
                    + '\nAdresse du domicile habtuel :  ' + this.decede.adresse
                    + '\nY a-t-il un obstacle médico-légal?  ' + this.getTexte(this.decede.obstacle)
                    + '\n N° de l\'acte au registre des décès :  ' + this.decede.id,
                },
                {
                  border: [true, false, true, true],
                  fontSize: 10,
            ...
            body: [
              ...
              [{text: 'Milieu de résidence' , border: [true, false, false, false],
               ...
               // margin: [0, 10, 0, 10]
                ...
                {text: this.decede.lieuxDeces , border: [false, false, true, false],
                  fontSize: 12,
                  }],
            ],
          },
          ...
          table: {
            ...
            body: [
              ...
              [
              {
                border: [true, true, true, false],
                margin: [0, 5, 0, 0],
                text: 'S\'agit-il d\'un mort-né?  ' + this.getTexte(this.decede.mortNe) + '  Lieu de décès : ' + this.decede.lieuxDeces
                  + '\n Sexe : ' + this.decede.sexe + '  Date de décès : '
                  + this.decede.dateDeces +
                  + '\n Nationalité : ' + this.decede.nationalite + '   Etat matrimonial : ' + this.decede.Etat +
                  ' \nDate de naissance : ' + this.decede.dateNaissance,
              },
                ],
            ],
              ...
              [
                    ...
                    '\nLa grossesse a-t-elle contribué au decès ? ' + this.ContribueGros},
                {
                 text: 'Décès périnatal \n' +
                   ...
                   '-Maladie ou affection maternelle ayant affecté le foetus ou le nouveau-né: ' + this.maladie},
              ],
              [
                {
